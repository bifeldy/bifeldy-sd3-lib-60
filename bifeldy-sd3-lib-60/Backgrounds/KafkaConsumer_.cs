            ...
            try {
                ...
                while (!stoppingToken.IsCancellationRequested) {
                    ...
                    try {
                        ...
                        _ = await generalRepo.SaveKafkaToTable(this._env.IS_USING_POSTGRES, orapg, result.Topic, result.Offset.Value, result.Partition.Value, result.Message, this._logTableName);
